...
/**
 * Movement processor for the "Move to Destroy bridges" order.
 *
 * @author fragkakis
 */
public class MoveToDestroyBridgeMovementProcessor extends BaseOrderMovementProcessor {
     ...
     */
    public MoveToDestroyBridgeMovementProcessor(MovementProcessor movementProcessor) {
