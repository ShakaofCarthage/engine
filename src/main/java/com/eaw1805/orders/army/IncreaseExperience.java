...
public class IncreaseExperience
     ...
     */
    private static final Logger LOGGER = LogManager.getLogger(IncreaseExperience.class);

    /**
     * Type of the order.
     */
    public static final int ORDER_TYPE = ORDER_INC_EXP;
     ...
     */
    public IncreaseExperience(final OrderProcessor myParent) {
        super(myParent);
