...
/**
 * Increase the experience of all brigades that are part of an Army.
 */
public class IncreaseExperienceArmy extends AbstractOrderProcessor
        implements GoodConstants, RegionConstants {

    /**
     * a log4j logger to print messages.
     */
    private static final Logger LOGGER = LogManager.getLogger(IncreaseExperienceArmy.class);

    /**
     * Type of the order.
     */
    public static final int ORDER_TYPE = ORDER_INC_EXP_ARMY;
     ...
     */
    public IncreaseExperienceArmy(final OrderProcessor myParent) {
        super(myParent);
