...
/**
 * Order - Increase Headcount.
 * ticket:27.
 */
public class IncreaseHeadcount
     ...
     */
    private static final Logger LOGGER = LogManager.getLogger(IncreaseHeadcount.class);

    /**
     * Type of the order.
     */
    public static final int ORDER_TYPE = ORDER_INC_HEADCNT;
     ...
     */
    public IncreaseHeadcount(final OrderProcessor myParent) {
        super(myParent);
