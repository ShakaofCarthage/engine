...
/**
 * Order - Increase Headcount for corps.
 */
public class IncreaseHeadcountCorps extends AbstractOrderProcessor
        implements GoodConstants, RegionConstants {

    /**
     * a log4j logger to print messages.
     */
    private static final Logger LOGGER = LogManager.getLogger(IncreaseHeadcountCorps.class);

    /**
     * Type of the order.
     */
    public static final int ORDER_TYPE = ORDER_INC_HEADCNT_CORPS;
     ...
     */
    public IncreaseHeadcountCorps(final OrderProcessor myParent) {
        super(myParent);
